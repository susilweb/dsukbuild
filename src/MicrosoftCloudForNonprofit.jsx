          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6 align-self-center">
                <img
                  src="/assets/img/Not-For-Profit-banner.png"
            ...
            <div className="row position-relative">
              <div className="col-lg-6 ">
                <div className="busine_service_bottom-right-indst">
                  <div className="card_new_img">
                    <img
                      src="/assets/img/icons-nonprofits_Constituent Management.svg"
                ...
                <div className="busine_service_bottom-right-indst">
                  <div className="card_new_img">
                    <img
                      src="/assets/img/icons_Personalized Engagement.svg"
              ...
              <div className="col-lg-6">
                ...
                <div className="busine_service_bottom-right-indst">
                  <div className="card_new_img">
                    <img
                      src="/assets/img/icons-nonprofits_program delivery.svg"
