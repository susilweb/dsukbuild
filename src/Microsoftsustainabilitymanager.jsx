      ...
      <section className="Solution-banner hero-1 hero">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <img
                src="/assets/img/Microsoft-Sustainability-Manager.png"
              ...
              <div className="row justify-content-center">
                <div className="col-lg-9 col-md-8">
                  <header className="section-header">
                    ...
                    <p>
                      <NavLink
                        to="/blog/microsoft-cloud-for-sustainability/"
                        target="_blank"
                      >
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="commen-box-2">
                <div className="icons size-new">
                  <img
                    src="/assets/img/Sustainable-Infrastructure.svg"
            ...
            <div className="col-lg-4">
              <div className="commen-box-2">
                <div className="icons size-new">
                  <img
                    src="/assets/img/Centralize-Data-Insights.svg"
            ...
            <div className="col-lg-4">
              <div className="commen-box-2">
                <div className="icons size-new">
                  <img
                    src="/assets/img/Reducing-Impacts.svg"
