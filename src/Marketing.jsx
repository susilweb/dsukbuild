                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons_centeralised-source.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons_Personalized-Communication-.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons_Journey-Mapping.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons_Email-Templates-.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons_Customer-Feedback-.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons_Automated-Lead-Scoring.svg"
                ...
                <div className="accordion" id="accnewss">
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img src="/assets/img/Group11.png" alt="Group11" />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img src="/assets/img/Group12.png" alt="Group12" />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img src="/assets/img/Group13.png" alt="Group13" />
                        </div>
                        <span>Forms Pro</span>
                      </button>
                    </h3>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img src="/assets/img/Group14.png" alt="Group14" />
                        </div>
                        <span>Add-Ons</span>
                      </button>
                    </h3>
