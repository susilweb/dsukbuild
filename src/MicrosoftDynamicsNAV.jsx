    ...
    <>
        ...
        <div className="container">
          ...
          <div className="col-lg-6 align-self-center">
              ...
              <div className="custom002">
                <p>Microsoft Dynamics NAV (Navision) is a stand-alone business management solution capable of streamlining and optimising all processes while generating opportunities for sustainable growth. Being one of the top <NavLink to="/products/microsoft-dynamics-erp/">Microsoft ERP solutions</NavLink>, it offers powerful features to manage and control all business processes. Built specifically for SMBs, it is capable of connecting all departments, including finance, sales, warehousing, operations, customers, supply chain, accounting, and inventory. Dynamics NAV is so powerful that it can automate most of the recurring and manual processes using the capabilities of AI (artificial intelligence) and BI (business intelligence) while enhancing the overall efficiency of the business.  </p>

                <p>Microsoft NAV provides a centralised platform to connect, collaborate, and share data using a single dashboard for ease of use and accessibility. This enables the users to take intelligent, smart, and fast decisions to succeed on the right path of growth. The NAV system offers rich functionality to help you unlock the full potential of your business, resulting in maximised efficiency while improving relations with customers for a greater experience.</p>
                <p>Businesses are unique, and so are their processes. This Microsoft ERP is so flexible that it fits in all industries, irrespective of the size and business requirements. You can make this ERP solution personalised using your <NavLink to="/">Microsoft Gold Partner</NavLink>, resulting in enhanced productivity and efficiency. One of the best parts of using the Microsoft NAV software is its support for multi-language and multi-currency to improve global operations. It makes the business financially stable throughout tough business situations. </p>
              </div>
            </div>
              ...
              <div className="finace-acc">
                ...
                <div className="accordion-item">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                       <p>Businesses have the choice to opt for the desired deployment option. NAV generally comes with an on-premises deployment option, but you can avail yourself of the cloud deployment option by upgrading your current NAV version to Business Central. You can also use the hybrid deployment option to access the combined capability of on-premises and cloud.</p>
                      </div>
                    </div>
                  </div>
                  <hr />
            ...
            <div className="col-lg-6">
              <div className="finace-acc">
                ...
                <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                       <p>The basic requirement of Dynamics NAV is having an internal Dynamics NAV support team to keep the system working 24x7, even in tough times. It eliminates the dependency on third-party NAV support partners, resulting in a focus on business growth.</p>
                      </div>
                    </div>
                  </div>
                  <hr />
      ...
      <section className="call-to-action-center hero-4">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="call-to-action-content">
                <h3>Looking for a reliable, supportive, and cost-effective Dynamics NAV Support Partner?</h3>
        ...
        <header className="section-header">
            ...
            <p>With your current NAV version, you may be experiencing a number of issues, such as performance issues, lags during processing, costly maintenance, a complex user interface, and ineffective features. It might be possible that your current NAV version is inefficient for tackling your current business requirements. If so, your current system needs an urgent upgrade. </p>
            <p>You have two options: upgrade your NAV version to the latest available version or upgrade the whole ERP system to Business Central. Both of these options would cost the same, but upgrading to Business Central is the long-term solution on which you can rely in the future.</p>
            <p>If you've been using NAV for a while and want to keep the same user interface and accessibility for a few more years, you can upgrade to the latest version. In both cases, Dynamics Square is available to understand your business and suggest the best possible solution.</p>
            <p>“Want to <NavLink to="/dynamics-nav-to-business-central/">upgrade your current Dynamics NAV</NavLink> version to streamline modern business demands?"</p>
            <p> <NavLink to="/schedule-a-demo">"Get Started Now!”</NavLink></p>
          </header>
          </div>
          </section>
          <section className="Solution-business-whys">
        ...
        <div className="row">
          <div className="col-lg-6">
          <div class="busine_service_bottom-left custom012"><img src="/assets/img/microosoft-partner.png" alt="microosoft-partner.png" /></div>
          </div>
          <div className="col-lg-6">
            <div className="side-heading">
            <h2>Dynamics NAV vs Dynamics 365 Business Central</h2>
            <p><NavLink to="/dynamics-365-business-central/">Dynamics 365 Business Central</NavLink> is the evolved and modern version of NAV software, specially built to aid SMBs with their core business management processes. The major differences between these two applications are listed below:</p>
            <ul> 
              <li><b>Deployment Option</b>: NAV works with on-premises deployment only, whereas Business Central is flexible enough to deploy data servers using on-premises, cloud, or hybrid deployment. </li>
              <li><b>Upfront Investment Cost</b>: Dynamics NAV implementation needs a huge investment to set up for a business, whereas <NavLink to="/dynamics-365-business-central-implementation/">Business Central implementation</NavLink>  works on a monthly subscription basis due to cloud deployment. </li>
              <li><b>Maintenance Cost</b>: You will need an internal IT team to support all kinds of maintenance and hardware upgrades, resulting in a lot of investment, whereas Business Central will be maintained by Microsoft at no extra cost and without hampering the current processes. </li>
              <li><b>Simple User Interface</b>: The user interface of NAV software is a bit complex, and new users find it difficult to understand. On the other hand, MS Dynamics 365 Business Central offers a simple yet powerful user interface where all the functions and tools are easily accessible. </li>
              <li><b>Personalization</b>: NAV provides limited personalization for all industries and requires significant resources to implement. Furthermore, when it comes to Business Central, extensions, add-ons, and other simple-to-implement apps are available to make the Microsoft ERP work for you.</li>
            </ul>
            </div>
          </div>
        </div>
      ...
      <section className="call-to-action-center hero-4">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="call-to-action-content">
                <h3>Is your NAV working properly with all your business processes? Upgrade it now!</h3>
                <div className="text-center m-o-t new-btn-nn">
                  <NavLink data-bs-toggle="modal"
                    to="#exampleModal" className="btn-get-started scrollto">
