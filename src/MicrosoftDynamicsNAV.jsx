        ...
        <div className="container">
          ...
          <div className="col-lg-6 align-self-center">
              ...
              <div className="custom002">
                <p>Formerly known as Navision, Dynamics NAV is an all-in-one business management solution capable of automating and connecting operations from all departments, including finance, sales, warehousing, operations, customers, supply chain, accounting, and stock management. It is one of the <NavLink to="/products/microsoft-dynamics-erp/">Microsoft Dynamics ERP solutions</NavLink> which is specifically built for SMBs. Dynamics NAV helps businesses increase profits while optimising and utilising their existing processes and resources.</p>
