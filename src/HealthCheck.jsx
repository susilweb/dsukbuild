        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <img
                src="/assets/img/why-Free-Health-Check-1024x-576.png"
          ...
          <div className="row p-433">
            <div className="col-lg-5 align-self-center">
              <div className="left-pic-nn">
                <img
                  src="/assets/img/feature-review.png"
                  alt="feature-review"
                />
              </div>
            </div>
        ...
        <div className="container">
          <div className="row pad9x rever-1">
            <div className="col-lg-5 align-self-center">
              <div className="commen-lef-pic">
                <img src="/assets/img/code-auditing.png" alt="code-auditing" />
              </div>
            </div>
          ...
          <div className="row pad9x">
            ...
            <div className="col-lg-5 align-self-center">
              <div className="commen-lef-pic">
                <img
                  src="/assets/img/Upgrading-Analysis.png"
          ...
          <div className="row pad9x rever-1">
            <div className="col-lg-7 align-self-center">
              <div className="commen-lef-pic">
                <img
                  src="/assets/img/data-health-check.png"
