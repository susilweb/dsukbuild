        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <img src="/assets/img/Fno-Sap-Erp.png" alt="Fno-Sap-Erp" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="content-box-222">
                <img
                  src="/assets/img/dynamics-finace.png"
                  alt="dynamics-finace"
                />
                <p>
            ...
            <div className="col-md-6">
              <div className="content-box-222">
                <img src="/assets/img/sap-erp.png" alt="sap-erp" />
                <p>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 align-self-center">
              <div className="call_to_action-left">
                <h3>
                  Thinking about implementing Dynamics 365 Business Central?
                </h3>
                <p>
...
export default FinancevsSapErp;
