            ...
            <div className="col-lg-3 col-6">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-1" rel="" target="_self">
                  <img
                    src="/assets/img/Power-bi-pic-1.png"
            ...
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <NavLink data-bs-toggle="modal" to="#powerBIModal">
                  <img
                    src="/assets/img/powerb-guide-call-to-banner-1.png"
                    alt="power-guide"
                  />
                </NavLink>
              </div>
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-2293.png"
                  alt="The wonderful company uses Power BI for easy reporting and dashboards"
                />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/842619-the-wonderful-company-consumer-goods-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img
                  src="/assets/img/group-2294.png"
                  alt="Kuwait international uses power bi for data visualisation"
                />
                <ExternalLink href="https://customers.microsoft.com/fr-fr/story/dgca-government-azure">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img
                  src="/assets/img/group-2295.png"
                  alt="Nokia implemented Power BI for HR to get real-time insights"
                />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/842850-nokia-telecommunications-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <NavLink data-bs-toggle="modal" to="#powerBIModal">
                  <img
                    src="/assets/img/powerb-guide-call-to-banner-2.png"
                    alt="power-guide"
                  />
                </NavLink>
              </div>
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2224-4.png" alt="group-2224" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21212.png"
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21213.png" alt="import data" />
              </div>
              <div className="cont-table-inner">
                <ul>
                  <li>
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21214.png"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21215.png"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21216.png"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21201.png"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21202.png"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21203.png"
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21204.png" alt="Pin to Dashboard" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21205.png" alt="Pin Live button" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21206.png"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21207.jpg"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21208.jpg"
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21209.jpg"
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img
                  src="/assets/img/group-21211.png"
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2227.png" alt="power bi version" />
              </div>
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <NavLink data-bs-toggle="modal" to="#powerBIModal">
                  <img
                    src="/assets/img/powerb-guide-call-to-banner.png"
                    alt="power-guide"
                  />
                </NavLink>
              </div>
