        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <img
                src="/assets/img/power-automate-banner.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons-power-automate_Quick-and-Secure.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons-power-automate_Enhanced-Efficiency.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons-power-automate_AI-Support.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/icons-power-automate_Highly-Compatible.svg"
            ...
            <div className="col-lg-6 align-self-center">
              <div className="busine_service_bottom-left">
                <div className="busine_service_bottom-right">
                  <img
                    src="/assets/img/power automate-side.png"
                    className="fix-im"
                  ...
                  <div className="video-ytube video-ytubes">
                    <div className="popup-btn popup-btns">
                      ...
                      >
                        <img src="/assets/img/Video Power-automate.png" alt="Power-automate" />
