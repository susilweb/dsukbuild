        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-7 align-self-center text-center">
              <img src="/assets/img/group-2308.png" alt="group-2308" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-1" rel="" target="_self">
                  <img src="/assets/img/Power-bi-pic-1.png" alt="Power BI" />
                  <h3>Chapter 1</h3>
            ...
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-2" rel="" target="_self">
                  <img
                    src="/assets/img/power-2.png"
            ...
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-3" rel="" target="_self">
                  <img src="/assets/img/power-3.png" alt="Power BI Dashboard" />
                  <h3>Chapter 3</h3>
            ...
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-4" rel="" target="_self">
                  <img
                    src="/assets/img/power-4.png"
            ...
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-5" rel="" target="_self">
                  <img src="/assets/img/power-5.png" alt="Power BI Versions" />
                  <h3>Chapter 5</h3>
            ...
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-6" rel="" target="_self">
                  <img src="/assets/img/power-6.png" alt="Power BI vs Others" />
                  <h3>Chapter 6</h3>
            ...
            <div className="col-lg-3">
              <div className="table-of-content-list text-center">
                <ExternalLink href="#tabs-7" rel="" target="_self">
                  <img src="/assets/img/Future-Scope.png" alt="Future-Scope" />
                  <h3>Chapter 7</h3>
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/Group-2175.png" alt="Group-2175" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2176.png" alt="group-2176" />
              </div>
              <div className="cont-table-inner">
                <p>
                  As per the survey organized by{" "}
                  <ExternalLink
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2174.png" alt="group-2174" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2183.png" alt="group-2183" />
              </div>
              <div className="cont-table-inner">
                <p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <header className="section-header section-header-tabless">
                ...
                <p>
                  In this section, we will get to know about the history, <br />{" "}
                ...
                <div className="balnde-imge-mode">
                  ...
                  />
                  <img
                    src="/assets/img/over-lay-shape.png"
                    alt="over-lay-shape"
                    className="overlay-1"
                  />
                </div>
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2265.png" alt="group-2265" />
              </div>
              <div className="cont-table-inner">
                <p>
                ...
                <p>
                  ...
                  <br className="mrg" />
                  As per the{" "}
                  <ExternalLink href="https://powerbi.microsoft.com/en-us/blog/microsoft-named-a-leader-in-the-2022-gartner-magic-quadrant-for-analytics-and-bi-platforms/">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2288.png" alt="group-2288" />
              </div>
              <div className="cont-table-inner">
                <p>
                  Power BI collects the data from different sources, visualises
                  it, and shows it on a single interactive dashboard to get
                  accurate intelligence reports to make actionable decisions.
                </p>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2185.png" alt="group-2185" />
              </div>
              <div className="cont-table-inner">
                <p>
                  ...
                  inaccuracy.{" "}
                  <ExternalLink href="https://techjury.net/blog/business-intelligence-statistics/#gref">
                    (Source)
                  </ExternalLink>
                </p>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2188.png" alt="group-2188" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2322.png" alt="group-2322" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2210.png" alt="group-2210" />
              </div>
              <div className="cont-table-inner">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2216.png" alt="group-2216" />
              </div>
              <div className="cont-table-inner">
                <p>
                ...
                <p>
                  Power BI is one of the simple yet powerful data analytics
                  tools for organizations, whether small or large. It provides
                  seamless data visualisation and reporting to the users,
                  helping them serve the organization as well as the customers
                  better. There are various components that help the users to
                  achieve such exceptional outcomes.
                </p>
                <ul>
                  <li>
                    <b>Power Query</b>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2293.png" alt="group-2293" />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/817472-grundfos-manufacturing-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2294.png" alt="group-2294" />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/810496-sandvik-coromant-chemicals-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2295.png" alt="group-2295" />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/791222-rockwell-automation-manufacturing-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-22.jpg" alt="group-22" />
              </div>
              <div className="cont-table-inner cont-table-inner-ds">
                <p className="down-pdf">
                  <NavLink data-bs-toggle="modal" to="#powerBIModal">
                    Don't have time to read the entire guide?{" "}
                    <span>Just download it as a PDF </span> and read it offline,
                    anytime, anywhere.
                  </NavLink>
                </p>
              </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <header className="section-header section-header-tabless">
                ...
                <p>
                  Power BI contains a lot of features and capabilities to aid
                  simple data visualisation for processing complex data.
                </p>
                <div className="balnde-imge-mode">
                  <img
                    src="/assets/img/group-2282.png"
                    alt="group-2282"
                    className="shape-1"
                  />
                  <img
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              <div className="cont-table-inner">
                <p>
                  <b className="h3">
                    Below, some notable features are mentioned:
                  </b>
                </p>
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2220.png" alt="group-2220" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2278.png" alt="group-2278" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2299.png" alt="group-2299" />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/817472-grundfos-manufacturing-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2300.png" alt="group-2300" />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/810496-sandvik-coromant-chemicals-power-bi">
                  (Source)
                </ExternalLink>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2301.png" alt="group-2301" />
                <ExternalLink href="https://customers.microsoft.com/en-us/story/791222-rockwell-automation-manufacturing-power-bi">
                  (Source)
                </ExternalLink>
              </div>
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2223.png" alt="group-2223" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2224.png" alt="group-2224" />
              </div>
              <div className="cont-table-inner">
                <p>
                ...
                <ul>
                  <li>
                    ...
                    <ExternalLink href="https://go.microsoft.com/fwlink/?LinkId=529784">
                  ...
                  <li>
                    ...
                    <ExternalLink href="http://app.powerbi.com">
                      Power BI Service
                    </ExternalLink>{" "}
                    by entering this link -{" "}
                    <ExternalLink href="http://app.powerbi.com">
                      app.powerbi.com
                    </ExternalLink>
                  </li>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21212.png" alt="group-21212" />
              </div>
              <div className="cont-table-inner">
                <ul>
                  <li>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21213.png" alt="group-21213" />
              </div>
              <div className="cont-table-inner">
                <ul>
                  <li>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21214.png" alt="group-21214" />
              </div>
              <div className="cont-table-inner">
                <ul>
                  <li>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21215.png" alt="group-21215" />
              </div>
              <div className="cont-table-inner">
                <ul>
                  <li>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21216.png" alt="group-21216" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21201.png" alt="group-21201" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21202.png" alt="group-21202" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21203.png" alt="group-21203" />
              </div>
              <div className="cont-table-inner">
                <p>
                  5. To view all the visuals of the report, select the Pin to
                  Dashboard button available in upper-right corner of the menu
                  bar; as shown below.
                </p>
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-21204.png" alt="group-21204" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21205.png" alt="group-21205" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21206.png" alt="group-21206" />
              </div>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2302.png" alt="group-2302" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2306.png" alt="group-2306" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2305.png" alt="group-2305" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2304.png" alt="group-2304" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2307.png" alt="group-2307" />
              </div>
              <div className="cont-table-inner">
                <p>
                ...
                <p>
                  <b className="h3">
                    Case Studies in Brief: Health Industry Used Cases{" "}
                  </b>
                </p>
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21207.jpg" alt="ggroup-21207" />
              </div>
              <div className="cont-table-inner">
                <p>
                  <b className="h3">Finance Industry Used Cases</b>
                </p>
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21208.jpg" alt="ggroup-21208" />
              </div>
              <div className="cont-table-inner">
                <p>
                ...
                <p>
                  <b className="h3">Systems and Digital Solution Provider</b>
                </p>
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21209.jpg" alt="ggroup-21209" />
              </div>
              <div className="cont-table-inner cont-table-inner-ds">
                <p className="down-pdf">
                  <NavLink data-bs-toggle="modal" to="#powerBIModal">
                    Did you find our guide interesting and would like to share
                    it with your colleagues?{" "}
                    <span>Download this guide as a PDF</span>.
                  </NavLink>
                </p>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <header className="section-header section-header-tabless">
                ...
                <p>
                  Power BI is a flexible yet powerful tool to provide
                  best-in-class data analysis and visualisation. It supports
                  several native as well as third-party apps for integration to
                  enhance the capabilities of overall business management.
                </p>
                <div className="balnde-imge-mode">
                  <img
                    src="/assets/img/PowerBi-integration.png"
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-21211.png" alt="group-21211" />
              </div>
              <div className="cont-table-inner cont-table-inner-ds">
                <p className="down-pdf">
                  <NavLink data-bs-toggle="modal" to="#powerBIModal">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <header className="section-header section-header-tabless">
                ...
                <p>
                  In this section, you will get to know about the different
                  versions of Power BI, along with their pricing and licensing.
                </p>
                <div className="balnde-imge-mode">
                  <img
                    src="/assets/img/PowerBi-Licensing.png"
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2227.png" alt="group-2227" />
              </div>
                  ...
                  <div className="body-in">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ExternalLink href="https://www.microsoft.com/en-in/microsoft-365/enterprise/e5">
              ...
              <div className="cont-table-inner">
                ...
                <p>
                  ...
                  offer various{" "}
                  <ExternalLink href="https://nonprofit.microsoft.com/register">
              ...
              <div className="cont-table-inner">
                ...
                <p>
                  ...
                  hour. The cost it carries is <b>£.85 per hour.</b>
                </p>
                <p>
                  <b>A4 Node:</b>
                </p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2221.png" alt="group-2221" />
              </div>
              <div className="iner-pp">
                <img src="/assets/img/group-2222.png" alt="group-2222" />
              </div>
              <div className="cont-table-inner cont-table-inner-ds">
                <p className="down-pdf">
                  <NavLink data-bs-toggle="modal" to="#powerBIModal">
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              <div className="cont-table-inner">
                <p>
                  In this section, we are going to compare the features and
                  capabilities of these tools with Power BI.
                </p>
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2225.png" alt="group-2225" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2256.png" alt="group-2256" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2258.png" alt="group-2258" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2259.png" alt="group-2259" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2260.png" alt="group-2260" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2261.png" alt="group-2261" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2262.png" alt="group-2262" />
              </div>
              <div className="cont-table-inner cont-table-inner-ds">
                <p className="down-pdf">
                  <NavLink data-bs-toggle="modal" to="#powerBIModal">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <header className="section-header section-header-tabless">
                ...
                <p>
                  Like other technologies, BI will keep evolving to cope with
                  the ways of modern business. It is becoming more productive,
                  efficient, and user-friendly by leveraging the power of the
                  cloud, AI, and ML to leverage data effectively.
                </p>
                <div className="balnde-imge-mode">
                  <img
        ...
        <div className="container">
          <div className="row justify-content-center g-4">
            <div className="col-lg-12">
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2298.png" alt="group-2298" />
              </div>
              <div className="cont-table-inner">
                <p>
              ...
              <div className="iner-pp">
                <img src="/assets/img/group-2312.png" alt="group-2312" />
              </div>
              ...
              <div className="cont-table-inner">
                ...
                <p>
                  We are a certified{" "}
                  <NavLink to="/">Microsoft gold partner</NavLink> and a leading{" "}
                ...
                <p>
                  ...
                  <NavLink to="/case-studies/">300+ happy clients</NavLink>{" "}
                ...
                <p>
                  ...
                  SMBs. Please <NavLink to="/contact-us/">contact us</NavLink>{" "}
