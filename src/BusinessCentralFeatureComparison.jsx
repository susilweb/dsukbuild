        ...
        <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/General-Funcionalities.png" alt="General-Funcionalities" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Finance-Management-chart.png" alt="Finance-Management-chart" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Manufacturing-chart.png" alt="Manufacturing-chart" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Supply-Chain-Management-chart.png" alt="Supply-Chain-Management-chart" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Business-Intelligence-and-Reporting-chart.png" alt="Business-Intelligence-and-Reporting-chart" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Service-Management-chart.png" alt="Service-Management-chart" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Project-management-chart.png" alt="Project-management-chart" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Sales-marketing-comparsion.png" alt="Sales-marketing-comparsion" />
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            ...
            <div className="col-lg-12">
              <div className="newfigure">
                <img src="/assets/img/Cloud-workflow-document.png" alt="Cloud-workflow-document" />
              </div>
            </div>
            <div className="col-lg-8 col-md-8">
              <p className="text-center">We hope you found this comparison useful. If you still have questions about Dynamics 365 Business Central or any other Dynamics 365 application, please feel free to reach out to us at <ExternalLink href="tel:+442071932502"><b>+44 207 193 2502</b></ExternalLink> or email <ExternalLink href="mailto:info@dynamicssquare.co.uk"><b>info@dynamicssquare.co.uk</b></ExternalLink></p>
            </div>
          </div>
        </div>
      </section>
