        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <img src="/assets/img/power-platform.png" alt="power-platform" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
            ...
            <div className="col-lg-8 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link to="/products/microsoft-power-bi/">Find Out More</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row pad9x">
            <div className="col-lg-8 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link to="/products/microsoft-power-apps/">Get Started</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-4 align-self-center ">
          ...
          <div className="row pad9x rever-1">
            <div className="col-lg-4 align-self-center">
              <div className="commen-lef-pic power-custom text-center">
                <img
                  src="/assets/img/Power-Automate.png"
                  alt="Power-Automate"
                />
              </div>
            </div>
            <div className="col-lg-8 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link to="/products/microsoft-power-automate/">
                    Find Out More
                  </Link>
                </div>
              </div>
          ...
          <div className="row pad9x pad11x">
            <div className="col-lg-8 align-self-center">
              <div className="commen-rit-info">
                ...
                <div className="cltt-actt">
                  <Link to="/products/microsoft-power-virtual-agents/">
                    Find Out More
                  </Link>
                </div>
              </div>
            ...
            <div className="col-lg-4 align-self-center">
              <div className="commen-lef-pic power-custom text-center">
                <img
                  src="/assets/img/Virtual-Agent.png"
                  alt="Virtual-Agent"
                />
              </div>
            </div>
