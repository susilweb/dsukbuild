          ...
          <div className="row">
            <div className="col-lg-6 mobile-1 align-self-center">
              ...
              <p>
                ...
                stocking at warehouses, and transportation for distribution. All
                of which contribute to maximising operational efficiency,
            ...
            <div className="col-lg-6 align-self-center">
              <img
                src="/assets/img/Dynamics365-SCM.png"
                alt="Dynamics365-SCM"
              />
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-12">
                ...
                <table className="table table-striped   align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>SOC 1 Type 1 certification</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Cost accounting workspace for mobile app</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Cost management content pack for Power BI</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>Data management and integration</td>
                      <td>&nbsp;</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Configuration-driven extension</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Export data to your own data warehouse</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        Enable the export of incremental updates to a data
                        entity
                      </td>
                      <td>Yes</td>
                      <td>Yes</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Electronic reporting (ER)</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>ER: Integration with LCS</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>ER: Integration with SharePoint</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        ER: Integration with Regulatory Configuration Services
                        (RCS)
                      </td>
                      <td>Yes</td>
                      <td>No</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        ER: Uses local file system as storage of ER
                        configurations accessible via ER repositories
                      </td>
                      <td>No</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Integration with PowerBI.com</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Integration with PowerBI Desktop</td>
                      <td>No</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Analytical workspaces</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Intelligent business process: Recommendations</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        Authoring Power BI reports with OData using Power BI
                        desktop or Excel PowerQuery tools
                      </td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        SQL Server Reporting Services (SSRS) supports scaling
                        out
                      </td>
                      <td>Yes</td>
                      <td>No</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Telemetry is transferred into the cloud</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Configurable business processes</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>Master planning and forecasting</td>
                      <td>&nbsp;</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>Mobile app, workspaces, and platform</td>
                      <td>&nbsp;</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Purchase spend analysis Power BI reports</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Production performance Power BI reports</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Mobile warehouse app</td>
                      <td>Yes</td>
                      <td>Yes</td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>Warehousing Power BI reports</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>
                        Task recorder - Save or load task recordings from the
                        BPM library
                      </td>
                      <td>Yes</td>
                      <td>No</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td>Access to Support via the Help &amp; Support menu</td>
                      <td>Yes</td>
                      <td>No</td>
                    </tr>
                  </tbody>
              ...
              <div className="consul-text">
                ...
                <p>
                  While this comparison will help you select the type of
                  deployment (in-cloud, on-premise) for your business, it is
...
export default ScmCloudvsonPremise;
