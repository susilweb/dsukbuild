...
<meta name="description" content="Arteak Limited worked with Dynamics Square to implement Microsoft Dynamics 365 Business Central online. Read Arteak case story to gain insights."/>
            ...
            <div className="col-lg-10">
              <div className="row bg-case">
                <div className="col-lg-3 align-self-center">
                  <img
                    src="/assets/img/Arteak-logo-small.png"
